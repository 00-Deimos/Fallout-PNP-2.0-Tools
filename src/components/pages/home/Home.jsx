...
export default function Home () {
    ...
    return (
        <main>
            ...
            <p>Fallout PNP 2.0 is a tabletop role-playing game created by Jason Mical's using a d100 system  designed to be flexible in its rule structure. The system of character creation and combat are drawn directly from Fallout’s <NavLink to="/special">SPECIAL</NavLink> system. Fallout PnP was created for two groups of gamers: those who enjoyed the Fallout computer games and wanted to have a tabletop version for their Saturday night role-playing sessions, and those people who had not played the computer game but were interested or curious in the post-Nuclear role-playing environment.</p>
            <h3>What do I need to play?</h3>
            <p>Each player needs a set of percentile-dice (two ten-sided dice, with one die representing the "ones" column and the other representing the "tens" column of a two-digit number). The Overseer needs a set of normal RPG dice as well (d4, d6, d8, d10, d12, d20). The group might want to have a pool of extra 10-sided dice for ease of play and rolling burst attacks all at once, as well. Each player also needs a character sheet (provided in a separate file), a pencil, and a bit of imagination. The Overseer needs this book and a little more imagination. A single hex-sheet is helpful, although not absolutely necessary. Every character can provide their own miniature figure to use on the hex sheet, and the Overseer may want to think about getting a few generic critter figures and some scenery (trees and ruined buildings, walls, etc), although these are not necessary either. It’s sometimes helpful to have a calculator for the mathematically-challenged, especially when firing guns in burst mode.</p>
            <h3>Disclaimer</h3>
