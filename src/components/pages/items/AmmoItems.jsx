...
export default function ItmWeapons () {
    ...
    return (
        <section>
            ...
            <p>Ammunition or ammo is the term used for expendable ordnance material used by the weapons of Fallout, such as powder, balls, shot, shells, percussion caps, rockets, missiles, energy, etc. The purpose of ammunition is to project force against a selected target or area. By general rule, AP (armor-piercing) rounds are designed for punching through armor plating. For this purpose they have a greatly strengthened case with a specially hardened and shaped nose. Due to the high muzzle velocity and penetrative properties of the round, damage to the target is slightly reduced, while JHP (Jacketed Hollow Point) bullets mushroom and break up on impact, causing massive trauma on fleshy, unarmored targets. However, this also means they break up when they hit things like armor plate, drastically reducing the weapon's penetrating power.</p> 
